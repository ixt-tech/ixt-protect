            ...
            <Grid.Column style={{maxWidth: 600}}>
              ...
              <Form size='large' error={this.state.formInvalid}>
                <Segment>
                  ...
                  <Form.Group>
                    <Form.Input name='firstName' fluid label='First name' onChange={this.handleChange}
                                placeholder='First name' required width={8}/>
                    <Form.Input name='lastName' fluid label='Last name' onChange={this.handleChange}
                                placeholder='Last name' required width={8}/>
                  </Form.Group>

                  <Form.Group>
                    <Form.Input name='dateOfBirthDay' label='Date of Birth' onChange={this.handleDateChange}
                                placeholder='Day' control='select' required>
                    ...
                    <Form.Input name='dateOfBirthMonth' placeholder='Month' onChange={this.handleDateChange}
                                control='select' className='no-label'>
                    ...
                    <Form.Input name='dateOfBirthYear' placeholder='Year' onChange={this.handleDateChange}
                                control='select' className='no-label'>
                  ...
                  <Form.Group>
                    <Form.Input name='addressLine1' fluid label='Address' onChange={this.handleChange}
                                placeholder='Address line 1' width={16} required/>
                  </Form.Group>

                  <Form.Group>
                    <Form.Input name='addressLine2' fluid placeholder='Address line 2' onChange={this.handleChange}
                                width={16}/>
                  </Form.Group>

                  <Form.Group>
                    <Form.Input name='town' fluid label='Town' onChange={this.handleChange} placeholder='Town' width={8}
                                required/>
                    <Form.Input name='postcode' fluid label='Postcode' onChange={this.handleChange}
                                placeholder='Postcode' width={8} required/>
                  </Form.Group>

                  <Form.Group>
                    <Form.Input name='country' label='Country' onChange={this.handleCountryChange} placeholder='Country'
                                control='select' required width={8}>
