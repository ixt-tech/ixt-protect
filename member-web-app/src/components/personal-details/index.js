...
class PersonalDetails extends React.Component {
  ...
  render() {
    ...
    if(this.state.editMode) {
      ...
      return (
        <Form size='large' error={this.state.formInvalid} onSubmit={this.handleSaveAccount}>
          <Segment padded>
            <Header>Your details</Header>
            <Divider/>
            ...
            <Button color='orange' basic floated='right'>Save</Button>
            <Button color='orange' basic onClick={this.toggleEditMode} floated='right'>Cancel</Button>
          ...
          <Grid>
            ...
            <Grid.Row>
              <Grid.Column width={16}>
                <Button icon basic color='orange' floated='right' onClick={this.toggleEditMode}>
                  <Icon name='edit' /> Edit your details
                </Button>
              </Grid.Column>
            </Grid.Row>
          </Grid>
